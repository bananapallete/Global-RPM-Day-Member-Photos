...
> **상태: 완료 (2026-07-20)** — 280장 전량 다운로드·검증, thumbs-polo 280장 생성, data.js에 photoPolo/thumbPolo 280건 반영, 브라우저 검증(토글·다운로드 메뉴) 통과.
> 참고: MCP 자산 URL은 렌더링 완료 전 HTTP 202(빈 응답)를 반환하므로, 202일 때 재시도(폴링)하는 다운로드가 필요함.
